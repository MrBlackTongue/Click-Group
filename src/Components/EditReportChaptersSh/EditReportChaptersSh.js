                ...
                <div className='edit-info-chapters'>
                    ...
                    >
                        ...
                        <Form.Item label="">
                            ...
                            <div className=''>1.1. Состояние блока (АС) до отклонения.</div>
                            <TextArea rows={8} value={this.state.un_state}/>
                        </Form.Item>

                        <Form.Item label="">
                            <div className=''>1.2. Описание последовательности отказов, ошибок персонала в ходе отклонения.</div>
                        ...
                        <Form.Item label="">
                            <div className=''>1.4. Предшествующие аналогичные отклонения.</div>
                        ...
                        <Form.Item label="">
                            ...
                            <div className=''>3.1. Перечень отказов, ошибок персонала в ходе отклонения.</div>
