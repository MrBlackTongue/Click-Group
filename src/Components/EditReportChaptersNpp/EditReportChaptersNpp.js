...
export default class EditReportChaptersNpp extends Component {
    constructor(props) {
        super(props);
    ...
    async componentDidMount() {
        ...
        await fetch(`http://185.246.64.43:8080/input/rest/npp_chapters/${id}`)
            ...
            <div className='edit-report-sh'>
                ...
                <div className='edit-info-chapters'>
                    ...
                    >
                        ...
                        <Form.Item label="">
                            <div className='label'>2. ПОСЛЕДСТВИЯ НАРУШЕНИЯ</div>
                        ...
                        <Form.Item label="">
                            <div className='label'>5. НЕДОСТАТКИ, ВЫЯВЛЕННЫЕ ПРИ РАССЛЕДОВАНИИ НАРУШЕНИЯ</div>
                        ...
                        <Form.Item label="">
                            <div className='label'>8. ПЕРЕЧЕНЬ ПРИЛОЖЕНИЙ К ОТЧЕТУ О РАССЛЕДОВАНИИ НАРУШЕНИЯ В РАБОТЕ АС</div>
